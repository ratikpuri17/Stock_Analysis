...
def predict():
    ...
    if(len(vals[3])==0):
        print("DEFAULT")
        s,seed_=recommending(vals[0],vals[1],vals[2],n)
        
    else: 
        s,seed_=recommending(vals[0],vals[1],vals[2],n,vals[3])
   ...
   # url ='/static/images/new_plot.png')
    ...
    return render_template('index.html', prediction_text=s,img=vals[3],num=n,r=r)
